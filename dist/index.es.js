...
var S = /* @__PURE__ */ ((r) => (r.person = "person", r))(S || {}), p = /* @__PURE__ */ ((r) => (r.de = "de", r.fr = "fr", r.en = "en", r.it = "it", r.nl = "nl", r))(p || {});
class m {
  constructor(t, e, i) {
    l(this, "projectSlug");
...
export {
  m as MetagridApi,
  S as MetagridEntities,
  p as MetagridLanguages,
  b as credit,
  v as widget
};
